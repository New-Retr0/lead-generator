-- Partner primary_phone is the atomic DM phone only — never coalesce to Google main_phone.
-- Recreates partner_leads_v1 from 20260717223000_drop_need_signals_column.sql shape.
...
select
  ...
  nullif(trim(l.enriched_json ->> 'best_contact_phone'), '') as primary_phone,
