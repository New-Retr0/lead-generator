-- Exterior cleaning need_signals are no longer a product surface (dashboard / Partner API).
-- Drop and recreate partner_leads_v1 without need_signals. Historical
-- enriched_json.exterior_cleaning_need_signals values stay on public.leads.
