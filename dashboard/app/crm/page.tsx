...
import { CRM_STATUSES, type CrmStatus, type LeadRow } from "@/lib/types";
  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-muted-foreground">
        Callable leads with a shared status the whole team can manage.
      </p>
                ...
                >
                  ...
                  <TableCell onClick={(e) => e.stopPropagation()}>
                    <Select
                      ...
                      onValueChange={(v) => void setStatus(lead.place_id, v as CrmStatus)}
                    >
                      <SelectTrigger
