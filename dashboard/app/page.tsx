...
export default function OverviewPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader description="PALLARES lead engine at a glance — Central Valley exterior cleaning.">
        <Button variant="outline" onClick={runDoctor}>
        ...
        <Card className="glass">
          <CardContent className="py-8 text-center">
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Launch a run once to create the lead database.
            </p>
          </CardContent>
        </Card>
      ) : (
      ...
      <Dialog open={doctorOpen} onOpenChange={setDoctorOpen}>
        <DialogContent className="glass-strong glass-sheen sm:max-w-2xl">
          ...
          <JobLogPanel jobId={doctorJobId} onDone={refreshOverview} />
        </DialogContent>
      </Dialog>
    </div>
  );
