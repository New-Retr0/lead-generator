  ...
  try {
    ...
    attentionItems = [
      ...
      },
      {
        ...
        href: "/data?inventory=unverified",
        tone: "secondary",
        hint: "Phone or thin contact — still tryable; missing a verified named DM",
      },
    ];
  } catch (err) {
    ...
    attentionItems = [
      ...
      },
      {
        ...
        href: "/data?inventory=unverified",
        tone: "secondary",
        hint: "Callable phone on file without a verified named DM — still tryable",
      },
    ];
  }
